...
class MainViewModel : ViewModel() {
    ...
    private fun createAdjustedModel(originalModel: Model3D, adjustments: ManualAdjustmentData): Model3D {
        ...
        val adjustedVertices = originalModel.vertices.map { vertex ->
            ...
            if (adjustments.rotationX != 0f) {
                val radX = Math.toRadians(adjustments.rotationX.toDouble())
            ...
            if (adjustments.rotationY != 0f) {
                val radY = Math.toRadians(adjustments.rotationY.toDouble())
            ...
            if (adjustments.rotationZ != 0f) {
                val radZ = Math.toRadians(adjustments.rotationZ.toDouble())
